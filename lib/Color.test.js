...
describe('Color.js', () => {
	describe('constructor()', () => {
		...
		test('passes given valid Hex', () => {
			...
			expect(act.a).toEqual(parseInt(1, 16))
		})
...
*/
	...
	describe('toArray()', () => {
		...
		test('returns RGBA array', () => {
			const color = new Color({ r: 1, g: 2, b: 3, a: 0.5 })
			expect(color.toArray()).toMatchObject([1, 2, 3, 0.5])
		})
	})
...
/*
		test('returns RGBA hex string', () => {
			const color = new Color({ r: 1, g: 2, b: 3, a: 4 })
			expect(color.toString()).toEqual('#01020304')
		})
*/
	})
	...
	describe('toRgbString()', () => {
		...
		test('returns CSS RGBA string', () => {
			const color = new Color({ r: 1, g: 2, b: 3, a: 0.5 })
			expect(color.toRgbString()).toEqual('rgba(1 2 3 / 0.5)')
		})
	})
})
