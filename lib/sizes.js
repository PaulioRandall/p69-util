export const sizeMap = (sizeMap, userOptions = {}) => {
	const options = prepMapOptions(userOptions)
	const result = sizeMappers(sizeMap, userOptions)
...
export const sizeMappers = (sizeMap, userOptions = {}) => {
	const options = prepMapOptions(userOptions)
...
export const absSizeMap = (sizeMap, userOptions = {}) => {
	const result = absSizeMappers(sizeMap, userOptions)
...
export const absSizeMappers = (sizeMap, userOptions = {}) => {
