export const sizeMap = (map, userOptions = {}) => {
	const options = prepOptions(userOptions)
	const result = sizeMappers(map, userOptions)
...
export const sizeMappers = (map, userOptions = {}) => {
	const options = prepOptions(userOptions)
...
export const absSizeMap = (map, userOptions = {}) => {
	const options = prepAbsOptions(userOptions)
	const result = absSizeMappers(map, userOptions)
...
export const absSizeMappers = (map, userOptions = {}) => {
	const options = prepAbsOptions(userOptions)
